...
class PartyViewDataService
{
    ...
    private function mapQuest(Quest $quest): array
    {
        return [
            ...
            'endingReleaseLabel' => $quest->ending_release_label ?: 'Ende 1',
            'endingRelease' => $quest->ending_release,
            'endingCaptureLabel' => $quest->ending_capture_label ?: 'Ende 2',
    ...
    private function defaultActiveQuests(): array
    {
        return [[
            ...
            'endingReleaseLabel' => 'Ende 1: Der Ork wird freigelassen',
            ...
            'endingCaptureLabel' => 'Ende 2: Der Ork wird gefangen oder getoetet',
