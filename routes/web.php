...
use App\Http\Controllers\Admin\CheckDifficultyController as AdminCheckDifficultyController;
...
Route::prefix($adminPrefix)->name('admin.')->group(function () use ($adminLoginPath) {
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        Route::get('/check-difficulties', [AdminCheckDifficultyController::class, 'index'])->name('check-difficulties.index');
        Route::post('/check-difficulties', [AdminCheckDifficultyController::class, 'store'])->name('check-difficulties.store');
        Route::get('/check-difficulties/{checkDifficulty}/edit', [AdminCheckDifficultyController::class, 'edit'])->name('check-difficulties.edit');
        Route::post('/check-difficulties/{checkDifficulty}', [AdminCheckDifficultyController::class, 'update'])->name('check-difficulties.update');
        Route::post('/check-difficulties/{checkDifficulty}/toggle', [AdminCheckDifficultyController::class, 'toggle'])->name('check-difficulties.toggle');
        Route::post('/check-difficulties/{checkDifficulty}/delete', [AdminCheckDifficultyController::class, 'destroy'])->name('check-difficulties.destroy');
